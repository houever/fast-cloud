...
public class MyAutoGenerator {
        ...
        while(i$.hasNext()) {
            ...
            if (config.getStrategyConfig().isEntityBooleanColumnRemoveIsPrefix()) {
                ...
                while(iterator.hasNext()) {
                    ...
                    if (field.getPropertyType().equalsIgnoreCase("boolean") && field.getPropertyName().indexOf("is") != -1) {
            ...
            ctx.put("parent",packageInfo.get("Entity").substring(0,packageInfo.get("Entity").lastIndexOf(".")));
    ...
    private void batchOutput(String entityName, VelocityContext context) {
        try {
            ...
            String entityFile = String.format((String)pathInfo.get("entity_path") + ConstVal.ENTITY_NAME, entityName);
            ...
            String serviceFile = String.format((String)pathInfo.get("serivce_path") + File.separator + tableInfo.getServiceName() + ".java", entityName);
            String implFile = String.format((String)pathInfo.get("serviceimpl_path") + File.separator + tableInfo.getServiceImplName() + ".java", entityName);
